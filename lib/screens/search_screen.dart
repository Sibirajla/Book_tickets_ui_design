...
import 'package:booktickets/widgets/double_text_winget.dart';
     ...
     return Scaffold(
       ...
       body:ListView(
         ...
         children: [
            ...
            Text(
             "What are\nYou locking for?",style: Styles.headLineStyle1.copyWith(fontSize: AppLayout.getWidth(35)),),
                       ...
                       Container(
                         ...
                         child:Column(
                           ...
                           children: [
                             ...
                             Text("Take the\nsurvey about\nour services\nand get\ndiscount",style: Styles.headLineStyle2.copyWith(fontWeight: FontWeight.w500,color: Colors.white,fontSize: 18),),
                           ],
                         ),
                       ),
                      Positioned(
